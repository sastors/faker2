...
https://lzdz1-isv.isvjcloud.com/dingzhi/personal/care/activity/8814802?activityId=dz210768869313&shareUuid=24f69db39f424a26b13708e0bdf56c76
https://lzdz1-isv.isvjcloud.com/dingzhi/personal/care/activity/8814802?activityId=dz210768869313&shareUuid=82688d773f95468ebde87d1b22a207c6
...
!(async () => {
  ...
  $.shareUuid = '82688d773f95468ebde87d1b22a207c6'
  // 232 23
...
function shopactivityId(functionId) {
  return {
    ...
    headers: {
      ...
      'Referer': `https://shopmember.m.jd.com/shopcard/?venderId=${functionId}&shopId=${functionId}&venderType=5&channel=401&returnUrl=https://lzdz1-isv.isvjcloud.com/dingzhi/personal/care/activity/8814802?activityId=dz210768869313&shareUuid=${$.shareUuid}`,
      'Cookie': cookie
    }
  }
}
...
function getHtml() {
  ...
  return new Promise(resolve => {
    $.get({
      url: `https://lzdz1-isv.isvjcloud.com/dingzhi/personal/care/activity/8814802?activityId=dz210768869313&shareUuid=${$.shareUuid}`,
      headers: {
        'User-Agent': $.UA,
        'Host':'lzdz1-isv.isvjcloud.com',
...
function adLog() {
  return new Promise(resolve => {
    let pageurl = `https://lzdz1-isv.isvjcloud.com/dingzhi/personal/care/activity/8814802?activityId=dz210768869313&shareUuid=${$.shareUuid}`
    $.post({
  ...
  return new Promise(resolve => {
    $.post({
      ...
      headers: {
        ...
        'Host':'lzdz1-isv.isvjcloud.com',
        'Content-Type': 'application/x-www-form-urlencoded; Charset=UTF-8',
        'Referer':`https://lzdz1-isv.isvjcloud.com/dingzhi/personal/care/activity/8814802?activityId=dz210768869313&shareUuid=${$.shareUuid}`,
        'Cookie': `LZ_TOKEN_KEY=${$.LZ_TOKEN_KEY}; LZ_TOKEN_VALUE=${$.LZ_TOKEN_VALUE}; AUTH_C_USER=${$.myPingData.secretPin}; ${$.lz_jdpin_token}`,
      }
    }, async (err, resp, data) => {
      try {
